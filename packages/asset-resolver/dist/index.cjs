...
exports.ASSET_CDN_BASE = stripTrailingSlash(
  readEnvBase() || DEFAULT_ASSET_CDN_BASE
);
function getAssetCdnBase() {
  return exports.ASSET_CDN_BASE;
}
function setAssetCdnBase(url) {
  if (!url) return;
  exports.ASSET_CDN_BASE = stripTrailingSlash(url);
}
...
exports.DEFAULT_ASSET_CDN_BASE = DEFAULT_ASSET_CDN_BASE;
exports.assetUrl = assetUrl;
exports.cdnAssetUrl = cdnAssetUrl;
exports.getAssetCdnBase = getAssetCdnBase;
exports.getPackIconForCategory = getPackIconForCategory;
exports.iconOnError = iconOnError;
exports.normalizeAssetPath = normalizeAssetPath;
exports.resolveIconUrl = resolveIconUrl;
exports.setAssetCdnBase = setAssetCdnBase;
