...
__export(index_exports, {
  ...
  createAnimPackNode: () => createAnimPackNode,
  createCharacterDeployBundle: () => createCharacterDeployBundle,
  createCharacterSpawnNode: () => createCharacterSpawnNode,
  createGraph: () => createGraph,
  createLocomotionNode: () => createLocomotionNode,
  createNode: () => createNode,
  createUuid: () => createUuid,
  createWeaponSkillNode: () => createWeaponSkillNode,
  findNode: () => findNode,
  linkNodes: () => linkNodes,
...
var import_bake = require("@grudge-studio/bake");
var import_units = require("@grudge-studio/units");
var import_core = require("@grudge-studio/core");
var QUALITY_SYSTEM = {
  version: "0.3.2",
  editorUrl: "https://forge.grudge-studio.com",
  cdn: import_core.DEFAULT_FLEET_URLS.assets,
  domains: ["bake", "character", "npc", "unit", "editor", "deployer", "runtime_3d"],
  characterDeploySteps: import_character.CHARACTER_DEPLOY_STEPS,
  characterKillList: import_character.CHARACTER_KILL_LIST,
  bakeGates: import_bake.BAKE_QUALITY_GATES,
  si: import_character.CHARACTER_SI,
  defaultUnitCount: import_units.DEFAULT_UNIT_CATALOG.length,
  defaultNpcCount: import_units.DEFAULT_NPC_CATALOG.length,
